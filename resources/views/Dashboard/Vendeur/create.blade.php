                    ...
                    <div class="col-md-10">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form"> Ajouter un Vendeur </h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{ route('admin.VendorStore')}}"
                                          method="POST"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <h4 class="form-section"><i class="ft-home"></i>   Les informations du Nouveau  Vendeur  </h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" value="{{ old('address') }}" id="address"
                                                                   class="form-control"
                                                                   placeholder="Adresse"
                                                                   name="address"
                                                                   minlength="3"
